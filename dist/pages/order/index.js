...
var OrderIndex = function (_wepy$page) {
  ...
  function OrderIndex() {
    ...
    }, _this.$props = { "OrderItem": { "xmlns:v-bind": { "for": "orders", "item": "item", "index": "index", "key": "index", "value": "item" }, "v-bind:order.once": { "for": "orders", "item": "item", "index": "index", "key": "index", "value": "item" } }, "ZanTab": { "xmlns:v-bind": "", "v-bind:tab.once": "tab", "handler": "onTabChange" } }, _this.$events = {}, _this.components = {
