...
const STATUS_ACTIONS = {
  // 外卖（线下）
  '20-0-2': [ACTION.REPRICE, ACTION.CLOSE, ACTION.TAKE],
  ...
  '30-0-1': [ACTION.REPRICE, ACTION.CLOSE],
  '30-0-2': [ACTION.CLOSE, ACTION.TAKE],
  '30-0-3': [ACTION.CLOSE, ACTION.REPRICE, ACTION.RECEIVE],
  '30-0-5': [ACTION.DEAL_REFUND],
  // 外带（线上）
  ...
  '33-0-1': [ACTION.REPRICE, ACTION.CLOSE],
  '33-0-2': [ACTION.CLOSE, ACTION.REPRICE, ACTION.TAKE],
  '33-0-3': [ACTION.CLOSE, ACTION.RECEIVE],
  '33-0-5': [ACTION.DEAL_REFUND],
  // 商城（线下）
  '10-0-2': [ACTION.REPRICE, ACTION.CLOSE, ACTION.SEND],
  ...
  '50-1-6': [ACTION.CLOSE_FORCE],
  // 砍价
  '70-1-2': [ACTION.SEND],
  '70-1-3': [ACTION.RECEIVE],
  '70-1-6': [ACTION.CLOSE_FORCE],
  // 虚拟商品（线上）
  '90-1-1': [ACTION.REPRICE, ACTION.CLOSE],
  '90-1-6': [ACTION.CLOSE_FORCE]
};
